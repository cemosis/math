...
\begin{itemize}
\only<1>{
\item \textbf{Fission nucl\'eaire}: production d'\'energie en utilisant la fission d'atomes lourds (uranium) par bombardement de neutrons (nucl\'eaire civil actuel).
\vspace{1mm}
